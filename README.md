...
![SwiftHire ATS Preview](https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&q=80&w=1000)
...
1. **Clone the repository** (or download the source code):
   ```bash
   git clone https://github.com/SoyPhilips/SwiftHire-ATS.git
   cd "SwiftHire-ATS"
   ```
...
- **Vibrant Color Palette**: Utilizing curated indigo and slate tones for a professional yet modern feel.
- **Micro-animations**: Smooth transitions and fade-in effects to enhance user engagement.
